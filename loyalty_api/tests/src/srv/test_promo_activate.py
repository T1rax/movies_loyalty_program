...
async def test_promo_activate_ok(pool, test_client, test_app, user_ids):
    promo_code = "7J2ep6M="
...
@pytest.mark.usefixtures("clean_table")
@pytest.mark.parametrize("clean_table", [LOYALTY_TABLES], indirect=True)
async def test_promo_code_for_user_not_found(pool, test_client, test_app):
    promo_code = "7J2ep6M="
    user_id = "a1bee0ec-02a2-42cf-9aa6-ee82835aabaf"
...
@pytest.mark.usefixtures("clean_table")
@pytest.mark.parametrize("clean_table", [LOYALTY_TABLES], indirect=True)
async def test_activation_limit_has_been_reached(pool, test_client, test_app):
    promo_code = "7J2ep6M="
    user_id = "a1bee0ec-02a2-42cf-9aa6-ee82835aabaf"
    activations_limit = 2
    body = {"promo_code": promo_code, "user_id": user_id}
...
@pytest.mark.usefixtures("clean_table")
@pytest.mark.parametrize("clean_table", [LOYALTY_TABLES], indirect=True)
async def test_user_has_already_activated_promo(pool, test_client, test_app):
    promo_code = "7J2ep6M="
    user_id = "a1bee0ec-02a2-42cf-9aa6-ee82835aabaf"
    activations_limit = 2
    body = {"promo_code": promo_code, "user_id": user_id}
